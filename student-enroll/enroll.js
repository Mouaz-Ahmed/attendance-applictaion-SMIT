import {getClassFromFirebase ,uploadImage, enrollingStudentFirebase} from '../firebase.js'
...
window.enrollStudentInDB = async function(){
    ...
    try{
        ...
        await enrollingStudentFirebase({studentName,fatherName,rollNumber,mobile,cnic,courseValue,classValue,imgUrl})
        alert('successfull')
